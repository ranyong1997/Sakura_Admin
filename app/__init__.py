...
from app.routes import api_router  # 路由
from app.setting import settings  # 配置文件
...
def register_static(app):
    ...
    @app.exception_handler(404)  # 全局异常处理
...
async def register_elasticsearch():  # 全局事件处理
    from app.utils.elastic import es, INDEX
    import aiomysql
    ...
    async def create_index():
        ...
        await es.indices.put_mapping(index=INDEX, mapping=mapping)  # 创建索引映射
