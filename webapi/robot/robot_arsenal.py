...
# @Author  : 冉勇
# @Site    : 
# @File    : robot_arsenal.py
# @Software: PyCharm
# @desc    : RobotArsenal 机器人武器库
import re
import time
import json
...
class RobotArsenal:
    ...
    def __request(self, url: str, headers: dict, req_body: dict, method='POST') -> dict:
        ...
        print("[RobotArsenal.__request] url:{0}, headers:{1}, req_body:{2}, method:{3}".format(url,
                                                                                               str(headers or default_headers),
                                                                                               str(req_body or {}),
                                                                                               method))
    ...
    def send_rich_message_to_chat(self, open_chat_id: str = None, chat_name: str = '', title: str = 'title',
                                  content: str = '', international: str = 'zh_cn'):
        """
    ...
    def send_rich_message_to_user(self, username: str, title: str = 'title', content: str = '',
                                  international: str = 'zh_cn'):
        """
