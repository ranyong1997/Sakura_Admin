...
class TencentCos(OssFile):
    ...
    def __init__(self, access_key_id: str, access_key_secret: str, region: str, bucket: str):
        self.bucket = bucket
        self.config = CosConfig(Region=region, SecretId=access_key_id, Secret_key=access_key_secret)
    ...
    def create_file(self, filepath: str, content: bytes, base_path: str = None):
        try:
            ...
            self.client.put_object(Bucket=self.bucket, Body=content, Key=key)
