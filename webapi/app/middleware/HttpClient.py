...
class Request(object):
    ...
    def response(status, request_data, status_code: 200, response=None, response_headers=None,
        ...
        request_headers = dict(request_headers.items()) if request_headers is not None else {}
        response_headers = dict(response_headers.items()) if response_headers is not None else {}
