...
@router.get("/gateway/list", summary="列出网关地址", tags=['Gateway'])
...
@router.post("/gateway/insert", summary="添加网关地址", description="添加网关地址,只有组长可以操作", tags=['Gateway'])
...
@router.post("/gateway/update", summary="编辑网关地址", description="编辑网关地址，只有组长可以操作", tags=['Gateway'])
...
@router.get("/gateway/delete", summary="删除网关地址", description="根据id删除网关地址，只有组长可以操作", tags=['Gateway'])
